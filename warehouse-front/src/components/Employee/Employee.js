    ...
    return(
      <div>
        ...
        <CardActions disableSpacing>
          ...
          <Button className={classes.buttonUpdate} color="secondary"
          onClick={() => setIsUpdateDialogOpen(true)}>Popraw</Button>
          <Button className={classes.buttonDelete} color="secondary"    
          onClick={() => setIsConfirmationDialogOpen(true)}
        
          variant="contained">Usuń</Button>
        </div>
        </CardActions>
