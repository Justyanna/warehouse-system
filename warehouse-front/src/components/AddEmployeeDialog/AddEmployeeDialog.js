...
const AddEmployeeDialog = (
    { firstName, setFirstName, lastName, setLastName, email, setEmail, password, 
        setPassword, passwordRe, setPasswordRe, phoneNumber, setPhoneNumber, salary, 
        setSalary, position, setPosition, roles, role, setRole, 
        isDialogOpen, handleCancel, handleAccept, handleChange, submitting, flatPropsRole, classes }) => (
