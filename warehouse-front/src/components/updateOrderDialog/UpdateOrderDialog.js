...
const UpdateOrderDialog = (
    { customer, totalPrice, status, newAddress, setNewAddress, newEmail, setNewEmail,
    phone, setPhone,  newname, setName, price, setPrice, newstatus, setNewStatus, submitting, handleChange, handleAccept, handleCancelUpdate, isUpdateDialogOpen}) => (
        ...
        <Dialog open={isUpdateDialogOpen} onClose={handleCancelUpdate}>
            ...
            <DialogActions>
                ...
                { newAddress || newEmail || phone || newname || price || status ?  <Button onClick={handleAccept} color="primary" autoFocus disabled={submitting}>
                Confirm
                </Button>:
